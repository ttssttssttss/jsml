...
COMPRESS      = gzip -9f
DISTNAME      = jsml1.0.0
DISTDIR = /home/troysung/sci/toB/jsml/intermidiate/jsml1.0.0
LINK          = g++
...
SOURCES       = browser.cpp \
		...
		urllineedit.cpp \
		webview.cpp \
		webpage.cpp intermidiate/qrc_simplebrowser.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents browser.h browserwindow.h tabwidget.h urllineedit.h webview.h webpage.h $(DISTDIR)/
	$(COPY_FILE) --parents browser.cpp browserwindow.cpp main.cpp tabwidget.cpp urllineedit.cpp webview.cpp webpage.cpp $(DISTDIR)/
...
compiler_rcc_make_all: intermidiate/qrc_simplebrowser.cpp
compiler_rcc_clean:
	-$(DEL_FILE) intermidiate/qrc_simplebrowser.cpp
intermidiate/qrc_simplebrowser.cpp: data/simplebrowser.qrc \
		...
		data/addtab.png
	/usr/lib64/qt5/bin/rcc -name simplebrowser data/simplebrowser.qrc -o intermidiate/qrc_simplebrowser.cpp
...
compiler_moc_header_make_all: intermidiate/moc_browserwindow.cpp intermidiate/moc_tabwidget.cpp intermidiate/moc_urllineedit.cpp intermidiate/moc_webview.cpp intermidiate/moc_webpage.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) intermidiate/moc_browserwindow.cpp intermidiate/moc_tabwidget.cpp intermidiate/moc_urllineedit.cpp intermidiate/moc_webview.cpp intermidiate/moc_webpage.cpp
...
intermidiate/qrc_simplebrowser.o: intermidiate/qrc_simplebrowser.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o intermidiate/qrc_simplebrowser.o intermidiate/qrc_simplebrowser.cpp
